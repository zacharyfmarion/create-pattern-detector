...
export function treeMakerOutputToFold(spec: TreeMakerAdapterSpec, output: TreeMakerExternalOutput & { _commandLabel?: string }): FOLDFormat {
  ...
  fold.file_description = "Synthetic CP generated from a TreeMaker-style external tree-base solver.";
  ...
  fold.label_policy = {
    ...
    notes: [
      "TreeMaker-compatible external solver output is canonical for this tree-base family.",
